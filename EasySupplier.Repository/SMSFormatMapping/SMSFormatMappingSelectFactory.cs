...
namespace BoilerSupplier.Repository
{
    ...
    internal class SMSFormatMappingSelectFactory : ISelectionFactory<SMSFormatMapping>
    {
        public IDbCommand ConstructSelectCommand(SMSFormatMapping idObject)
        {
            ...
            sqlCommand.CommandText = Constants.USP_ADD_DEL_UPDATE_SMS_FORMAT_MAPPING;
            return sqlCommand;
        }
    }
}
