...
namespace BoilerSupplier.Repository
{
    ...
    internal class SendBackSelectFactory : ISelectionFactory<SendBack>
    {
        public IDbCommand ConstructSelectCommand(SendBack idObject)
        {
            ...
            sqlCommand.CommandText = Constants.USP_ADD_DEL_UPDATE_SENDBACK;
            return sqlCommand;
        }
    }
}
