...
namespace BoilerSupplier.Repository
{
    ...
    internal class WithholdingTaxExeListSelectFactory : ISelectionFactory<WithholdingTaxExe>
    {
        public IDbCommand ConstructSelectCommand(WithholdingTaxExe idObject)
        {
            ...
            sqlCommand.CommandText = Constants.USP_GET_WITHHOLDING_TAX_EXE_LIST;
            return sqlCommand;
        }
    }
}
