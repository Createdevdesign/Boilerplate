...
namespace BoilerSupplier.Repository
{
    ...
    internal class RemarkSelectFactory : ISelectionFactory<Remark>
    {
        public IDbCommand ConstructSelectCommand(Remark idObject)
        {
            ...
            sqlCommand.Parameters.Add(Constants.PS_FIELD_ID, SqlDbType.VarChar, 250).Value = idObject.FieldId;
            sqlCommand.Parameters.Add(Constants.PS_REMARKS, SqlDbType.VarChar, 250).Value = idObject.Remarks;
            ...
            sqlCommand.CommandText = Constants.USP_ADD_DEL_UPDATE_REMARKS;
            return sqlCommand;
        }
    }
}
