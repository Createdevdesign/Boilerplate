...
namespace BoilerSupplier.Repository
{
    ...
    internal class ReqStatusSelectFactory : ISelectionFactory<ReqStatus>
    {
        public IDbCommand ConstructSelectCommand(ReqStatus idObject)
        {
            ...
            //sqlCommand.CommandText = Constants.USP_ADD_DEL_UPDATE_ReqStatus;
            return sqlCommand;
        }
    }
}
