...
namespace BoilerSupplier.Repository
{
    ...
    internal class RegisterSelectFactory : ISelectionFactory<Register>
    {
        public IDbCommand ConstructSelectCommand(Register idObject)
        {
            ...
            sqlCommand.CommandText = Constants.USP_ADD_DEL_UPDATE_REGISTER;
            return sqlCommand;
        }
    }
}
