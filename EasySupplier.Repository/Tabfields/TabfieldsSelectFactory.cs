...
namespace BoilerSupplier.Repository
{
    ...
    internal class TabfieldsSelectFactory : ISelectionFactory<Tabfields>
    {
        public IDbCommand ConstructSelectCommand(Tabfields idObject)
        {
            ...
            sqlCommand.Parameters.Add(Constants.PS_TOKEN, SqlDbType.NVarChar, 100).Value = idObject.Token;
            ...
            sqlCommand.CommandText = Constants.USP_GET_TAB_FIELDS;
            return sqlCommand;
        }
    }
}
