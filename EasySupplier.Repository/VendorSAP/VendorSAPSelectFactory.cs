...
namespace BoilerSupplier.Repository
{
    ...
    internal class VendorSAPSelectFactory : ISelectionFactory<VendorSAP>
    {
        public IDbCommand ConstructSelectCommand(VendorSAP idObject)
        {
            ...
            //sqlCommand.CommandText = Constants.USP_UPDATE_VENDOR_SAP;
            sqlCommand.CommandText = Constants.USP_VENDOR_SAP_DETAILS;
            return sqlCommand;
        }
    }
}
