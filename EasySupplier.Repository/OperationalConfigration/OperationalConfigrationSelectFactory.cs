...
namespace BoilerSupplier.Repository
{
    ...
    internal class OperationalConfigrationSelectFactory : ISelectionFactory<OperationalConfigrationMaster>
    {
        public IDbCommand ConstructSelectCommand(OperationalConfigrationMaster idObject)
        {
            ...
            sqlCommand.Parameters.Add(Constants.PS_SUB_MERCHANT_NAME, SqlDbType.NVarChar, 200).Value = idObject.Submerchantname;
           
            sqlCommand.Parameters.Add(Constants.PS_MERCHANT_NAME, SqlDbType.NVarChar, 200).Value = idObject.MerchantName;
            ...
            sqlCommand.CommandText = Constants.USP_ADD_DEL_UPDATE_OPERATIONAL_CONFIGRATION_MASTER;
            return sqlCommand;
        }
    }
}
