...
namespace BoilerSupplier.Repository
{
    ...
    internal class WIPApplicationListSelectFactory : ISelectionFactory<WIPApplicationList>
    {
        public IDbCommand ConstructSelectCommand(WIPApplicationList idObject)
        {
            ...
            sqlCommand.Parameters.Add(Constants.PN_EMP_ROLE_TYPE, SqlDbType.Int, 4).Value = idObject.EmpRoleType;
            ...
            sqlCommand.CommandText = Constants.USP_GET_WIP_APPLICATION_LIST;
            return sqlCommand;
        }
    }
}
