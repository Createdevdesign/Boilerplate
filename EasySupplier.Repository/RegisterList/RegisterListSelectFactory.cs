...
namespace BoilerSupplier.Repository
{
    ...
    internal class RegisterListSelectFactory : ISelectionFactory<RegisterList>
    {
        public IDbCommand ConstructSelectCommand(RegisterList idObject)
        {
            ...
            sqlCommand.CommandText = Constants.USP_GET_REGISTER_LIST;
            return sqlCommand;
        }
    }
}
