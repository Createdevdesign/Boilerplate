...
namespace BoilerSupplier.Repository
{
    ...
    internal class NDAAppSelectFactory : ISelectionFactory<NDAApp>
    {
        public IDbCommand ConstructSelectCommand(NDAApp idObject)
        {
            ...
            sqlCommand.CommandText = Constants.USP_GET_NDAAPP_DETAILS;
            return sqlCommand;
        }
    }
}
