...
namespace BoilerSupplier.Repository
{
    ...
    internal class NDAAppObjectFactory : IDomainObjectFactory<NDAApp>
    {
        public NDAApp Construct(IDataReader reader)
        {
            ...
            NDAApp.BankCountry = null != reader[Constants.OUT_BANK_COUNTRY] ? reader[Constants.OUT_BANK_COUNTRY].ToString().Trim() : string.Empty;
           NDAApp.MinorityIndicatorDate = null != reader[Constants.OUT_MINORITY_INDICATOR_DATE] ? Convert.ToDateTime(reader[Constants.OUT_MINORITY_INDICATOR_DATE].ToString().Trim()) : DateTime.Today;
